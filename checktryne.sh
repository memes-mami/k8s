...
echo "$cpu_percentage"  "$memory_percentage"
echo "cpu_percentage: $cpu_percentage"
echo "CPU_THRESHOLD: $CPU_THRESHOLD"
echo "memory_percentage: $memory_percentage"
...
echo "$NODE_NAME,$NODE_NAME2,$execution_time" >> curl_n_e.csv
...
echo "$NODE_NAME,$NODE_NAME2,$execution_time2" >> copy_tar_n_e.csv
else echo "hellooooooo"
fi
