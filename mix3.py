...
def get_zookeeper_pods_on_node(node_name):
    ...
    try:
        ...
        zookeeper_pods = [pod for pod in v1.list_namespaced_pod(namespace).items
...
if __name__ == "__main__":
    ...
    for i in range(0, len(df), chunk_size):
        ...
        script_arguments = [node_name, picked_zookeeper_pod.metadata.name if picked_zookeeper_pod else None]
