...
#total_percentage=$((cpu_percentage + memory_percentage))
...
echo "$NODE_NAME,$NODE_NAME2,$execution_time" >> curl_z_e.csv
...
echo "$NODE_NAME,$NODE_NAME2,$execution_time2" >> copy_tar_z_e.csv
fi
