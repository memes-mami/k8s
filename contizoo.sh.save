...
echo "$NODE_NAME,$WORKER_NODE,$execution_time" >> startup_latency_z_e.csv
...
new_value_formatted=$(printf "%.4f" "$new_value")
...
echo "$NODE_NAME,$WORKER_NODE,$execution_time2" >> extract_z_e.csv
