...
def get_zookeeper_pods_on_node(node_name):
    try:
        ...
        pod_list = v1.list_pod_for_all_namespaces(
            field_selector=f'spec.nodeName={node_name}', label_selector='app=zookeeper'
        )

        zk_pods = [pod.metadata.name for pod in pod_list.items]
        return zk_pods
...
if __name__ == "__main__":
    ...
    for i in range(0, len(df), chunk_size):
        ...
        script_arguments = [ranked_workers[0], picked_zookeeper_pod]
